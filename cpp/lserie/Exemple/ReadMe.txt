=================================================================================================
    BIBLIOTHÈQUE MICROSOFT FOUNDATION CLASS : Vue d'ensemble du projet SerialTest
=================================================================================================

AppWizard a créé cette application SerialTest à votre attention. Cette application
...
res\SerialTest.ico
    ...
    est incluse dans le fichier de ressources principal SerialTest.rc.
...
SerialTestDlg.h, SerialTestDlg.cpp - la boîte de dialogue
    Ces fichiers contiennent votre classe CSerialTestDlg, qui définit le
    comportement de la boîte de dialogue principale de votre application. Le modèle de boîte de
    dialogue se trouve dans le fichier SerialTest.rc, modifiable dans Microsoft Visual C++.
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h, StdAfx.cpp
    ...
    appelé SerialTest.pch, et un fichier de types précompilés StdAfx.obj.
